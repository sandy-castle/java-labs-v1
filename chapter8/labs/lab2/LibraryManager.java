...
public class LibraryManager
{
    ...
    public LibraryManager()
    {
        ...
        userBorrowMap = new HashMap<String, List<Book>>();
    ...
    public boolean borrowBook(String userId, String isbn) {
        ...
        for (Book book : books) {
            if (book.getIsbn().equals(isbn)) {
                List<Book> borrowedList = userBorrowMap.getOrDefault(userId, new ArrayList<>());
    ...
    public List<Book> getSortedBooksByPrice() {
        ...
        return books.stream()
                .sorted(Comparator.comparingDouble(Book::getPrice)) // getPrice()가 있을 경우
                .collect(Collectors.toList());
    }
